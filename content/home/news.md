...
+++
* 2021-June: The team I lead won the the championship (rank 1st) in the [sharedtask 3](https://github.com/IIGROUP/AutoIE2) at [NLPCC 2021](http://tcci.ccf.org.cn/conference/2021/cfpt.php). The goal of this task is to build an Information Extraction system that can quickly adapt to a new occurring sub-event.
